...
if __name__ == '__main__':
    ...
    model_path = r"C:\Users\chenjunzhou\Desktop\研究生\论文（曼巴病灶）\logs\LUNA16\mamba yolov8 16 C2DMSC xiaogai_Y8ZN（4300）\best.pt"
    ...
    result = model.val(
        ...
        project='logs/LUNA16_t/LUNA16_t_2.27',
        name='LUNA16_t_2.27',
        # plots=False,  # ← 强烈推荐
        )
    ...
    print("正在生成独立可视化预测图...")
    model.predict(
        source=r'C:\Users\chenjunzhou\Desktop\project\yolo_mamba-main\yolo_mamba-main\datasets\LUNA16\images\test',
        # 指向你的测试集图片文件夹
        imgsz=640,
        conf=0.25,  # 置信度阈值，可调
        save=True,  # ← 关键：保存带标签的图片
        project='logs/LUNA16_t/LUNA16_t_2.27',  # 保存到和 val 相同的目录下
        name='predict_visual',
        line_width=2,  # 框的粗细
        show_labels=True,
        show_conf=True
